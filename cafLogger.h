...
#define CAFFA_ERROR_SINK( SINK_NAME, MESSAGE )                                  \
    {                                                                           \
        caffa::Logger::get( SINK_NAME )->error( CAFFA_GENERATE_MSG( MESSAGE ) ) \
    }
#define CAFFA_WARNING_SINK( SINK_NAME, MESSAGE )                               \
    {                                                                          \
        caffa::Logger::get( SINK_NAME )->warn( CAFFA_GENERATE_MSG( MESSAGE ) ) \
    }
...
#define CAFFA_DEBUG_SINK( SINK_NAME, MESSAGE )                                  \
    {                                                                           \
        caffa::Logger::get( SINK_NAME )->debug( CAFFA_GENERATE_MSG( MESSAGE ) ) \
    }
#define CAFFA_TRACE_SINK( SINK_NAME, MESSAGE )                                  \
    {                                                                           \
        caffa::Logger::get( SINK_NAME )->trace( CAFFA_GENERATE_MSG( MESSAGE ) ) \
    }
...
#define CAFFA_CRITICAL( MESSAGE ) spdlog::critical( CAFFA_GENERATE_MSG( MESSAGE ) )
#define CAFFA_ERROR( MESSAGE ) spdlog::error( CAFFA_GENERATE_MSG( MESSAGE ) )
#define CAFFA_WARNING( MESSAGE ) spdlog::warn( CAFFA_GENERATE_MSG( MESSAGE ) )
#define CAFFA_INFO( MESSAGE ) spdlog::info( CAFFA_GENERATE_MSG( MESSAGE ) )
#ifndef NDEBUG
